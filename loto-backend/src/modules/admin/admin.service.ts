...
import { WithdrawService } from '../deposits/withdraw.service';
...
export class AdminService {
  ...
  async approveDeposit(depositId: string, adminEmail: string) {
    return this.depositsService.approveDeposit(depositId, adminEmail);
  }

  async rejectDeposit(depositId: string, adminEmail: string, reason: string) {
    return this.depositsService.rejectDeposit(depositId, adminEmail, reason);
  }

  async approveWithdraw(withdrawId: string, adminEmail: string) {
    return this.withdrawService.approveWithdraw(withdrawId, adminEmail);
  }

  async rejectWithdraw(withdrawId: string, adminEmail: string, reason: string) {
    return this.withdrawService.rejectWithdraw(withdrawId, adminEmail, reason);
  }
